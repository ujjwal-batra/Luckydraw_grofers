...
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #s', NOW() + INTERVAL -2 HOUR, NOW() + INTERVAL -1 HOUR, 'Washing Machine','Fridge','Realme XT');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #0', NOW() + INTERVAL 1 HOUR, NOW() + INTERVAL 2 HOUR, 'emtncexxyq','ovezswvd','qmsfiy');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #1', NOW() + INTERVAL 3 HOUR, NOW() + INTERVAL 4 HOUR, 'ujbhpixgnx','naepsjne','zdupez');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #2', NOW() + INTERVAL 5 HOUR, NOW() + INTERVAL 6 HOUR, 'tmffbqadda','pvtdzoqy','nmxnzp');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #3', NOW() + INTERVAL 7 HOUR, NOW() + INTERVAL 8 HOUR, 'yxjxlcsrfo','osjzmnqa','zacexn');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #4', NOW() + INTERVAL 9 HOUR, NOW() + INTERVAL 10 HOUR, 'hphinejjyg','hfvpwrkr','moaxci');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #5', NOW() + INTERVAL 11 HOUR, NOW() + INTERVAL 12 HOUR, 'dqfizcajid','jnuifqwg','zmsflv');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #6', NOW() + INTERVAL 13 HOUR, NOW() + INTERVAL 14 HOUR, 'krqwsydyce','hlplmqpu','pibbfi');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #7', NOW() + INTERVAL 15 HOUR, NOW() + INTERVAL 16 HOUR, 'xjmfgqjihg','czhpiqym','yzcsmi');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #8', NOW() + INTERVAL 17 HOUR, NOW() + INTERVAL 18 HOUR, 'abwrmtzemw','wnxlxilc','josbqo');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #9', NOW() + INTERVAL 19 HOUR, NOW() + INTERVAL 20 HOUR, 'jmiwqyxkej','cdqserbr','ljixfc');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #10', NOW() + INTERVAL 21 HOUR, NOW() + INTERVAL 22 HOUR, 'bebfbwbtug','suyzuxxb','iewcsg');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #11', NOW() + INTERVAL 23 HOUR, NOW() + INTERVAL 24 HOUR, 'akqdgmkmgj','wterqpgb','obtqwh');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #12', NOW() + INTERVAL 25 HOUR, NOW() + INTERVAL 26 HOUR, 'vxrnxdataf','zumeslyq','qgefpy');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #13', NOW() + INTERVAL 27 HOUR, NOW() + INTERVAL 28 HOUR, 'kabilpwlxp','wympwvee','lbqbef');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #14', NOW() + INTERVAL 29 HOUR, NOW() + INTERVAL 30 HOUR, 'bjdzdciqzj','qiuxpnvr','odlcme');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #15', NOW() + INTERVAL 31 HOUR, NOW() + INTERVAL 32 HOUR, 'hmaogymivd','alimjeup','vyqncf');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #16', NOW() + INTERVAL 33 HOUR, NOW() + INTERVAL 34 HOUR, 'fdlafzeeoc','axkglkcx','xypgfj');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #17', NOW() + INTERVAL 35 HOUR, NOW() + INTERVAL 36 HOUR, 'snmzsgrpvh','mtagjwfa','qhvsit');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #18', NOW() + INTERVAL 37 HOUR, NOW() + INTERVAL 38 HOUR, 'soxgquutue','slnfhlxl','qkpbiq');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #19', NOW() + INTERVAL 39 HOUR, NOW() + INTERVAL 40 HOUR, 'biveyasrpx','sbpuaisd','zuprtx');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #20', NOW() + INTERVAL 41 HOUR, NOW() + INTERVAL 42 HOUR, 'fobugbjrfc','xihjseut','oobrll');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #21', NOW() + INTERVAL 43 HOUR, NOW() + INTERVAL 44 HOUR, 'cneiltokmh','bccnurtm','yckrtk');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #22', NOW() + INTERVAL 45 HOUR, NOW() + INTERVAL 46 HOUR, 'vrfgszvmgl','dndqjxmv','erurdw');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #23', NOW() + INTERVAL 47 HOUR, NOW() + INTERVAL 48 HOUR, 'bptkkabcdn','tmsbyaqq','bxnxra');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #24', NOW() + INTERVAL 49 HOUR, NOW() + INTERVAL 50 HOUR, 'zqjfucsqpt','vtkvppzt','agdavo');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #25', NOW() + INTERVAL 51 HOUR, NOW() + INTERVAL 52 HOUR, 'lcjhutoxbj','bsypezaj','epiluu');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #26', NOW() + INTERVAL 53 HOUR, NOW() + INTERVAL 54 HOUR, 'qecabwhrqa','hudaqofn','trlbpl');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #27', NOW() + INTERVAL 55 HOUR, NOW() + INTERVAL 56 HOUR, 'sehroueqbv','nrriqnnn','laaxgn');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #28', NOW() + INTERVAL 57 HOUR, NOW() + INTERVAL 58 HOUR, 'ujbipeyfyt','zxzoexqv','yqutvu');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #29', NOW() + INTERVAL 59 HOUR, NOW() + INTERVAL 60 HOUR, 'kyiprmknqg','vzytupdh','nqycdd');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #30', NOW() + INTERVAL 61 HOUR, NOW() + INTERVAL 62 HOUR, 'lleoubgiwg','knxhijas','dprwvp');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #31', NOW() + INTERVAL 63 HOUR, NOW() + INTERVAL 64 HOUR, 'izhrpoynaf','tnmkohnu','grwnvn');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #32', NOW() + INTERVAL 65 HOUR, NOW() + INTERVAL 66 HOUR, 'xpwoqplypn','jyfdiuvf','ncrbau');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #33', NOW() + INTERVAL 67 HOUR, NOW() + INTERVAL 68 HOUR, 'sbuykhruzz','fkgtpuna','szxdxn');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #34', NOW() + INTERVAL 69 HOUR, NOW() + INTERVAL 70 HOUR, 'nglxmhcpnj','hhuwhviq','awwtun');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #35', NOW() + INTERVAL 71 HOUR, NOW() + INTERVAL 72 HOUR, 'hwulprpmuc','lvhoolgc','vbzats');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #36', NOW() + INTERVAL 73 HOUR, NOW() + INTERVAL 74 HOUR, 'ykbftqaksk','mtsnpxid','yaaeio');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #37', NOW() + INTERVAL 75 HOUR, NOW() + INTERVAL 76 HOUR, 'fatqocvxhl','ahtryvpm','ynatph');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #38', NOW() + INTERVAL 77 HOUR, NOW() + INTERVAL 78 HOUR, 'lnadbxwvef','ggaatcls','uuponn');
INSERT INTO luckydraw_event (Name, StartTime, EndTime, FirstPrize, SecondPrize, ThirdPrize) VALUES ('Lucky Draw #39', NOW() + INTERVAL 79 HOUR, NOW() + INTERVAL 80 HOUR, 'fmxtxhiedw','acfaigls','zgbnjz');
